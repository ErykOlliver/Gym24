...
export default function Treiners() {
    ...
    return (
        <section className="font-enconde-sans h-2/4 w-screen snap-start items-center gap-11 px-5 py-15 flex flex-col">
            <h1 className="sm:text-5xl text-3xl font-semibold">Trainers staff</h1>
            <div className="flex items-center justify-center sm:overflow-hidden no-scroll overflow-x-auto overflow-y-hidden scroll-smooth w-full ">
                <div className="lg:grid-cols-4 md:grid-flow-row md:grid-cols-3  grid grid-flow-col auto-cols-[275px] auto-rows-[448px] items-stretch px-5 py-2.5 w-fit gap-4.5 snap-x snap-mandatory">
