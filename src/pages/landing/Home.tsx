  ...
  return (
    <section className="Home snap-start h-screen w-screen relative bg-no-repeat bg-cover bg-center z-20 flex flex-col">
      ...
      <div className="relative px-2 flex flex-col gap-15 z-10 items-center justify-center h-full w-full">
        <h1 className="text-5xl text-white font-bold text-center font-enconde-sans">Free trial session with a trainer</h1>
        <a href="" className="text-base bg-solarFlare text-black font-enconde-sans flex items-center justify-center rounded-full font-bold w-44 h-14">Detailed</a>
      </div>
    </section>
  )
}
