export default function Home() {
  return (
    <section className="Home snap-start font-enconde-sans h-screen w-screen relative bg-no-repeat bg-cover bg-center z-20 flex flex-col">
      ...
      <div className="lg:px-25 sm:items-start relative px-2 flex flex-col gap-15 z-10 items-center justify-center h-full w-full">
        <h1 className="lg:w-1/2 sm:text-6xl sm:text-start text-5xl text-white font-bold text-center">Free trial session with a trainer</h1>
