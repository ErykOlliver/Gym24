...
export default function Footer() {
    return (
        <section className="sm:grid-cols-2 h-2/4 w-screen snap-start items-center font-enconde-sans gap-11 px-5 py-15 grid grid-cols-1">
            <article className="sm:text-start sm:items-start text-center px-22 flex flex-col items-center gap-5 h-full">
            ...
            <article className=" sm:text-start sm:items-start text-center px-22 flex flex-col items-center gap-5">
